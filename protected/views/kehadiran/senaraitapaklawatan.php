...
<h1>Laporan Peserta Lawatan Tapak</h1>
...
<?php $form = $this->beginWidget('CActiveForm',array('id' => 'kehadiran-form',)) ?>
    ...
    <?php echo CHtml::ajaxSubmitButton('Cari',array('ajaxreportlawatan'),array('update' => '#update'),array('class' => 'btn_search ui-corner-all'))?>
<?php $this->endWidget() ?>
