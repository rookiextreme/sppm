...
<h1>Maklumat Peserta bagi <?php echo $majlis->majlis; ?></h1><h3><i>(Kakitangan JKR)</i></h3>
...
<?php $form = $this->beginWidget('CActiveForm',array('id' => 'peserta-form',)) ?>
    ...
    <?php echo CHtml::ajaxSubmitButton('Cari',array('ajaxloadformawam'),array('update' => '#update'),array('id'=>'ajaxlink-'.uniqid(),'class' => 'btn_print ui-corner-all'))?>
