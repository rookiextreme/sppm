...
class Peserta extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('nokp, nama, organisasi, email', 'required', 'message' => '{attribute} mesti dilengkapkan.'),
			...
			array('organisasi, nama_pengganti, email_pengganti, tel_pengganti', 'safe'),
    ...
    public function getKategoriPeserta($idMajlis)
    {
        ...
        if($model->kategori_peserta) {
            ...
            foreach ($arr as $a) {
                $data[$a] = $this->kategori_peserta[$a];
            }
            return $data;
        }
    }
